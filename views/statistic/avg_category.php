 ...
 * Time: 20:50
 */
$this->title = 'Среднее по сопоставленным (категория)';
        ...
        <div class="box ">
            ...
            <div class="box-body">
                <table id="avg_category" class="table table-bordered">
                    ...
                    <?php foreach ($categoryLet as $key => $brand) : ?>
                        <tr>
                            <td><?= $key + 1; ?></td>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <table id="avg_category" class="table table-bordered">
                    ...
                    <?php foreach ($categoryRiv as $key => $brand) : ?>
                        <tr>
                            <td><?= $key + 1; ?></td>
                            <td><?= $brand['category']; ?></td>
                            <td><?= $brand['count']; ?></td>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <table id="avg_category" class="table table-bordered">
                    ...
                    <?php foreach ($categoryEli as $key => $brand) : ?>
                        <tr>
                            <td><?= $key + 1; ?></td>
                            <td><?= $brand['category']; ?></td>
                            <td><?= $brand['count']; ?></td>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <table id="avg_category" class="table table-bordered">
                    ...
                    <?php foreach ($categoryIle as $key => $brand) : ?>
                        <tr>
                            <td><?= $key + 1; ?></td>
                            <td><?= $brand['category']; ?></td>
                            <td><?= $brand['count']; ?></td>
