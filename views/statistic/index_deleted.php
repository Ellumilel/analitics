...
$this->title = 'Статистика удаленные';
                ...
                \yii\widgets\ListView::widget(
                    [
                        ...
                        'itemView' => function ($model, $key, $index, $widget) {
                            return $this->render('_list_item_deleted', ['model' => $model, 'link' => 'riv']);
                        },
                        'itemOptions' => [
                            'tag' => false,
                        ],
            ...
            <div class="box-body">
                ...
                \yii\widgets\ListView::widget(
                    [
                        ...
                        'layout' => "{items}\n{summary}\n{pager}",
                        'itemView' => function ($model, $key, $index, $widget) {
                            return $this->render('_list_item_deleted', ['model' => $model, 'link' => 'ile']);
                        },
                        'itemOptions' => [
                            'tag' => false,
                        ],
            ...
            <div class="box-body">
                ...
                \yii\widgets\ListView::widget(
                    [
                        ...
                        'layout' => "{items}\n{summary}\n{pager}",
                        'itemView' => function ($model, $key, $index, $widget) {
                            return $this->render('_list_item_deleted', ['model' => $model, 'link' => 'eli']);
                        },
                        'itemOptions' => [
                            'tag' => false,
                        ],
            ...
            <div class="box-body">
                ...
                \yii\widgets\ListView::widget(
                    [
                        ...
                        'layout' => "{items}\n{summary}\n{pager}",
                        'itemView' => function ($model, $key, $index, $widget) {
                            return $this->render('_list_item_deleted', ['model' => $model, 'link' => 'let']);
                        },
                        'itemOptions' => [
                            'tag' => false,
                        ],
