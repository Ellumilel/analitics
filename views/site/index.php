...
<div class="site-index">
        ...
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title"><?= Html::img('@web/image/main_logo.jpg', ['width' => 100]); ?></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            ...
                            <th>Количество сопоставленных</th>
                        </tr>
                        <tr>
                            <td>1.</td>
                            <td>Летуаль</td>
    ...
    <div class="row site-index-padding">
        <div class="col-md-6">
            <div class="box box-primary">
                <div class="box-header">
                ...
                <div class="box-body ">
                    <table class="table table-striped table-bordered">
                        ...
                        <tr>
                            <td style="color: #000000;background-color: #111111"><a target="_blank"
                                                                                    href="http://www.letu.ru/"><img
                                        src="http://www.letu.ru//common/img/logo.png" width="120px;"></a></td>
                            <td>Летуаль</td>
                        ...
                        <tr>
                            <td style="color: #000000;background-color: #111111"><a target="_blank"
                                                                                    href="http://shop.rivegauche.ru/store/ru/"><img
                                        src="http://shop.rivegauche.ru/media/images/h6b/h03/8807437893662.png"
                                        width="120px;"></a></td>
                            <td>РивГош</td>
                        ...
                        <tr>
                            <td style="color: #000000;background-color: #111111"><a target="_blank"
                                                                                    href="https://elize.ru/"><img
                                        src="https://elize.ru/img/logos/elize.jpg" width="120px;"></a></td>
                            <td>Элизэ</td>
                        ...
                        <tr>
                            <td style="color: #000000;background-color: #111111"><a target="_blank"
                                                                                    href="http://iledebeaute.ru/shop/"><img
                                        src="http://static.iledebeaute.ru/@/css/logo_idb.png" width="120px;"></a></td>
                            <td>Иль Де Ботэ</td>
                        ...
                        <tr>
                            <td><a target="_blank" href="http://www.podrygka.ru/"><?= Html::img(
                                        '@web/image/main_logo.jpg',
                                        ['width' => '80px;']
                                    ); ?></a></td>
                            <td>Подружка</td>
