...
class ExportExcel
{
    ...
    public function __construct($exportFile, $colCount, $rowCount)
    {
        ...
        $this->baseFullFilename = \Yii::$app->basePath.$this->exportDir.'/'.$this->exportFile;
    ...
    public function writeDocumentProperties()
    {
        ...
        fwrite($this->file, '<Author>admin</Author>');
        fwrite($this->file, '<LastAuthor>admin</LastAuthor>');
        $dt = new \DateTime();
        ...
        fwrite($this->file, '<Company>podruzka</Company>');
